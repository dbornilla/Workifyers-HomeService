...
import housepainting  from '../../../../Assets/images/housepainting.jpg'
...
const HousePainting = () => {
  return (
    <div className='housepaintingdetails'>
      <img src={housepainting} className="banner"/>

      <div className='heading'>
        <h1 className='detailsTitle'>House Painting</h1>
