...
import houseCleaning  from '../../../../Assets/images/housecleaning.jpg'
...
const HouseCleaning = () => {
  return (
    <div className='housecleaningdetails'>
      <img src={houseCleaning} className="banner"/>

      <div className='heading'>
        <h1 className='detailsTitle'>House Cleaning</h1>
